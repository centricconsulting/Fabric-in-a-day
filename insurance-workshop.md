...
Suppose you work for a insurance company.  You've been tasked with developing a solution that will monitor catostrophic claims as they are submitted and processed.  This solution will be leveraged by consumers to understand impact of events as they occur, allowing leadership to understand if they need to make adjustments to staffing or resources to support these events.
...
The claims database entities are:
